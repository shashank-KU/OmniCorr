...
# Path to the package raw-data
transcriptomics_path <- system.file("raw-data/transcriptomics", package = "OmniCorr")

# Load raw counts
host_gut_rawCounts_total1 <- read.table(file.path(transcriptomics_path, "Transcriptomics_count.txt.gz"), header = TRUE, row.names = 1)

# Load sample metadata
sample_info <- read.csv(file.path(transcriptomics_path, "sample_info.csv"), row.names = 1)

# Load gene annotations
annot_function <- read_tsv(file.path(transcriptomics_path, "Salmo_salar-GCA_905237065.2_gene_annotations.tsv"))

# Assign to analysis objects
