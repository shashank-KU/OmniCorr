...
raw <- import_biom(system.file("raw-data/metagenomics/feature-table_taxonomy.biom", package = "OmniCorr"))
tree <- read_tree(system.file("raw-data/metagenomics/tree.nwk", package = "OmniCorr"))
refseq <- Biostrings::readDNAStringSet(system.file("raw-data/metagenomics/dna-sequences.fasta", package = "OmniCorr"))
dat <- read.table(system.file("raw-data/metagenomics/metadata.txt", package = "OmniCorr"), header = TRUE, row.names = 1, sep = "\t")
