...
#' @param show_significance (optional) A logical indicating whether to show significance levels as stars or as p-value and correlation value. Default is TRUE (show stars).
#'
...
#' If show_significance is TRUE, the significance level is shown as stars;
#' otherwise, it is shown as the p-value and correlation value.
#'
#' @examples
...
#'
#' @export
calculate_correlations <- function(df1, df2, method = "pearson", adjust_method = "fdr", use = "all.obs", show_significance = TRUE) {
