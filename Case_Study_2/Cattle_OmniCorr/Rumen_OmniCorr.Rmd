...
load("data/ciliates.rds")
load("data/fungi.rds")
load("data/archbac.rds")
load("data/metazoa.rds")
load("data/metL.rds")
load("data/metW.rds")
load("data/annoD.rds")
load("data/metadata.rds")
```
...
if (!file.exists("Modules_rumen.RData")) {
  ...
  save(Ciliates.modules, Fungi.modules, Archbac.modules, Metazoa.modules, MetL.modules, MetW.modules, file = "Modules_rumen.RData")
  
} else {
  load("Modules_rumen.RData")
}
...
```{r for enrichment in github, eval=FALSE}
